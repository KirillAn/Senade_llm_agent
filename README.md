...
```
### 💾 Датасет
Собирался вручную, на основе данных пентеста

1️⃣ Анализ системы и разведка (Initial Recon & Exploitation) – уязвимые порты, слабые пароли.

2️⃣ Работа с сетевыми данными (Network & Data Forensics) – трафик, криптография.

3️⃣ Эксплуатация уязвимостей (Low-level Exploitation) – переполнение буфера, уязвимый код.

4️⃣ Реверс-инжиниринг и бинарные атаки (Binary Exploitation & Reverse Engineering) – анализ бинарников, обход защиты.

Пример:

<pre>
  <div id="header" align="center"> <img src=dataset_ex.png width="1000"/>
  </div>
</pre>

Всего собрано **103 сценария** атак, которые стали частью **52 промптов**
